  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url.get("todo/todayfuture")}}">Todo By Date <span class="sr-only">(current)</span></a>
        </li>
      </ul>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form action="{{url.get("todo/update")}}" method="post">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form action="{{url.get("todo/insert")}}" method="post">
              <div class="modal-body">
                  <div class="form-group">
                    <label for="todo" class="col-form-label">Todo Title:</label>
                    <input name="title" type="text" class="form-control" id="title" required>
